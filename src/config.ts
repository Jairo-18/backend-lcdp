export const config = async () => {
  ...
  return {
    app: {
      name: process.env.APP_NAME || 'LcdpApp',
    ...
    db: {
      ...
      database: process.env.DB_DATABASE || 'lcdp_db',
    ...
    mail: {
      ...
      sender: process.env.MAIL_SENDER || 'noreply@lacasadelpintor.com',
      secure: process.env.MAIL_SECURE === 'true',
    },
    webPush: {
      publicKey: process.env.VAPID_PUBLIC_KEY || '',
      privateKey: process.env.VAPID_PRIVATE_KEY || '',
      subject: process.env.VAPID_SUBJECT || 'mailto:admin@lacasadelpintor.com',
    },
    google: {
