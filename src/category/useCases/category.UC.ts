...
export class CategoryUC {
  ...
  async findOne(id: number)                             { return this._categoryService.findOne(id); }
  async update(id: number, dto: UpdateCategoryDto)      { return this._categoryService.update(id, dto); }
  async remove(id: number)                              { return this._categoryService.remove(id); }
}
